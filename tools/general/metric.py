...
if __name__ == '__main__':
    ...
    parser.add_argument('--pppred', type=str, default='/home/dsj/zyw_code/dataset/HCGMNetTestResults/SYSU/HCGMNet')
    parser.add_argument('--gggt', type=str, default='/home/jicredt_data/dsj/CDdata/SYSU-CD/test/label')
